package data_structures.Tree.tests;
...
public class TestArvoreBinaria {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Testes de travessia em data_structures.LinkedList");
        System.out.println("Travessia   in-order (data_structures.LinkedList):  " + arvore.inOrderToList());
        System.out.println("Travessia  pre-order (data_structures.LinkedList):  " + arvore.preOrderToList());
        System.out.println("Travessia post-order (data_structures.LinkedList):  " + arvore.postOrderToList());
